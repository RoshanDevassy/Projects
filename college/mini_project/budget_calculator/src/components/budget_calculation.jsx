          ...
          <section className="">
            ...
            >
              ...
              <div className="flex flex-col border border-black rounded-md sm:self-center">   
                <section
                  className="flex mb-2 gap-3 items-center justify-center rounded-md border-black border-x-8 border-b" /* "grid grid-cols-2 row-span-2 justify-self-center items-center gap-1 mb-1" */ /* "flex gap-3 items-center pb-2" */
                >
                  <img src={house} alt="house" className="h-5 w-5 xsm:h-6 xsm:w-6 sm:w-7 sm:h-7 lg:h-8 lg:w-8" />
                  <p className="font-semibold text-sm xsm:text-base sm:text-lg lg:text-xl font-serif">Needs</p>
                </section>
                <section
                  className="flex flex-col sm:self-center gap-1 text-sm xsm:text-base lg:text-lg font-mono font-semibold md:w-full p-1 *:flex *:flex-col *:items-center *:sm:flex-row *:sm:justify-between *:sm:items-center"/* "flex flex-col gap-1" */ /* "grid grid-rows-3 pb-5 gap-1" */ /* "grid grid-rows-3 pb-5 gap-1 md:flex flex-col" */
                >
                  <div
                  ...
                  <div
                    className="py-1" /* "grid grid-cols-2 bg-slate-100" */ /* "flex justify-around items-center flex-wrap" */ /* "grid grid-cols-2 place-self-center " */ /* "flex justify-between items-center flex-wrap" */
                  >
                    <p>My Budget</p>
                    <p>&#8377;{Math.ceil(props.needs_total).toFixed(2)}</p>
                  </div>
                  <div
                    className="" /* "grid grid-cols-2 " */ /* "flex justify-between items-center flex-wrap" */
                  >
              ...
              {/* Wants Wrapper*/}
              <div className="flex flex-col border border-black rounded-md sm:self-center">
                <section className="flex gap-3 items-center justify-center mb-2 border-b border-black border-x-8 rounded-md">
                  <img src={giftbox} alt="house" className="h-5 w-5 xsm:h-6 xsm:w-6 sm:w-7 sm:h-7 lg:h-8 lg:w-8" />
                  <p className="font-serif font-semibold text-sm xsm:text-base sm:text-lg lg:text-xl">Wants</p>
                </section>
                <section className="flex flex-col gap-1 text-sm xsm:text-base lg:text-lg basis-16 flex-shrink p-1 *:flex *:flex-col *:items-center *:sm:flex-row *:sm:justify-between *:sm:items-center px-[2px] font-mono font-semibold"/* "flex flex-col gap-1" *//* "grid grid-rows-3 pb-5 gap-1 " */>
                  <div className="">
                    <p>50/30/20</p>
              ...
              {/* Savings Wrapper*/}
              <div className="flex flex-col border border-black rounded-md sm:self-center">
                <section className="flex gap-3 items-center justify-center mb-2 border-black border-b border-x-8 rounded-md">
                  <img src={savings} alt="savings" className="h-5 w-5 xsm:h-6 xsm:w-6 sm:w-7 sm:h-7 lg:h-8 lg:w-8" />
                  <p className="font-serif font-semibold text-sm xsm:text-base sm:text-lg lg:text-xl">Savings</p>
                </section>
                <section className="flex flex-col gap-1 text-sm xsm:text-base lg:text-lg basis-16 flex-shrink p-1 *:flex *:flex-col *:items-center *:sm:flex-row *:sm:justify-between *:sm:items-center px-[2px] font-mono font-semibold"/* "grid grid-rows-3 gap-2" */>
                  <div className="">
                    <p>50/30/20</p>
