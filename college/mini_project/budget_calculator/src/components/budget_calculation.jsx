    ...
    <>
      <section className="font-sans">
        ...
        <section className="">
          ...
          <div
            className="flex flex-col self-center flex-wrap  md:flex-row *:flex-grow gap-2 w-full sm:gap-5 lg:gap-7 mt-3 xsm:mt-4 sm:mt-5 xl:mt-6 2xl:mt-8 3xl:mt-10"/* " flex flex-col self-center flex-wrap  md:flex-row *:flex-grow gap-2 w-full sm:gap-5 lg:gap-7 mt-3 xsm:mt-4 sm:mt-5 xl:mt-6 2xl:mt-8 3xl:mt-10" */ /* "md:flex md:justify-around md:items-center" */
          >
            {/* Needs wrapper*/}
            <div className="flex flex-col border border-black rounded-md sm:self-center">
              ...
              <section
                className="flex flex-col gap-3 p-1 sm:self-center text-xs xsm:text-sm sm:text-base lg:text-lg 3xl:text-xl font-mono font-semibold md:w-full  *:flex *:flex-col *:items-center *:sm:flex-row *:sm:justify-between *:sm:items-center" /* "flex flex-col gap-1" */ /* "grid grid-rows-3 pb-5 gap-1" */ /* "grid grid-rows-3 pb-5 gap-1 md:flex flex-col" */
              >
                <div
            ...
            {/* Wants Wrapper*/}
            <div className="flex flex-col border border-black rounded-md sm:self-center">
              <section className="flex gap-3 p-1 items-center justify-center mb-2 border-b border-black border-x-8 rounded-md">
                <img
                  src={giftbox}
                  alt="house"
              ...
              <section
                className="flex flex-col gap-3 text-sm xsm:text-base lg:text-lg basis-16 flex-shrink p-1 *:flex *:flex-col *:items-center *:sm:flex-row *:sm:justify-between *:sm:items-center px-[2px] font-mono font-semibold" /* "flex flex-col gap-1" */ /* "grid grid-rows-3 pb-5 gap-1 " */
              >
                <div className="">
                  <p>50/30/20</p>
            ...
            {/* Savings Wrapper*/}
            <div className="flex flex-col border border-black rounded-md sm:self-center">
              <section className="flex gap-3 p-1 items-center justify-center mb-2 border-black border-b border-x-8 rounded-md">
                <img
                  src={savings}
                  alt="savings"
                  className="h-4 w-4 xsm:h-5 xsm:w-5 sm:h-7 sm:w-7"
              ...
              <section
                className="flex flex-col gap-3 text-sm xsm:text-base lg:text-lg basis-16 flex-shrink p-1 *:flex *:flex-col *:items-center *:sm:flex-row *:sm:justify-between *:sm:items-center px-[2px] font-mono font-semibold" /* "grid grid-rows-3 gap-2" */
              >
                <div className="">
                  <p>50/30/20</p>
